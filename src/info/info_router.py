...
class InfoHandler:
    ...
    # --- 1. 아이템 조회 ---
    @info_router.post("/items", response_model=WrappedResponse[PaginatedItemResponse])
    ...
    # --- 2. 적 정보 조회 (목록/상세) ---
    @info_router.post("/enemies", response_model=WrappedResponse[PaginatedEnemyResponse])
    ...
    @info_router.get("/enemies/{enemy_id}", response_model=WrappedResponse[EnemyDetailResponse])
    ...
    # --- 3. NPC 정보 조회 (목록/상세) ---
    @info_router.post("/npcs", response_model=WrappedResponse[PaginatedNpcResponse])
    ...
    # --- 4. 성격 정보 조회 ---
    @info_router.post("/personalities", response_model=WrappedResponse[PaginatedPersonalityResponse])
    ...
    @info_router.get("/world", response_model=WrappedResponse[WorldResponse])
