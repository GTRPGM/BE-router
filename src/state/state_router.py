...
class StateRouter:
    ...
    async def start_session(
        ...
        return await proxy_request(
            "POST",
            STATE_MANAGER_URL,
            f"{self.base_prefix}/session/start",
            auth.credentials,
            json=params,
        )
    ...
    async def get_session(
        ...
        return await proxy_request(
            "GET",
            STATE_MANAGER_URL,
            f"{self.base_prefix}/session/{session_id}",
            auth.credentials,
        )
    ...
    async def get_player(
        ...
        return await proxy_request(
            "GET",
            STATE_MANAGER_URL,
            f"{self.base_prefix}/player/{player_id}",
            auth.credentials,
        )
    ...
    async def get_sequence_details(
        ...
        return await proxy_request(
            "GET",
            STATE_MANAGER_URL,
            f"{self.base_prefix}/session/{session_id}/sequence/details",
            auth.credentials,
        )
    ...
    async def get_act_details(
        ...
        return await proxy_request(
            "GET",
            STATE_MANAGER_URL,
            f"{self.base_prefix}/session/{session_id}/act/details",
            auth.credentials,
        )
    ...
    async def get_npcs(
        ...
        return await proxy_request(
            "GET",
            STATE_MANAGER_URL,
            f"{self.base_prefix}/session/{session_id}/npcs",
            auth.credentials,
        )
    ...
    async def get_enemies(
        ...
        return await proxy_request(
            "GET",
            STATE_MANAGER_URL,
            f"{self.base_prefix}/session/{session_id}/enemies",
            auth.credentials,
        )
    ...
    async def get_inventory(
        ...
        return await proxy_request(
            "GET",
            STATE_MANAGER_URL,
            f"{self.base_prefix}/session/{session_id}/inventory",
            auth.credentials,
        )
